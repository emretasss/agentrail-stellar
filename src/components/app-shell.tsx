...
export function AppShell({
  ...
  return (
    <div className="workspace-shell min-h-screen bg-background text-foreground">
      ...
      <nav className="workspace-mobile-nav fixed inset-x-3 bottom-3 z-30 grid grid-cols-9 rounded-2xl border border-white/[.09] p-1.5 shadow-2xl backdrop-blur-2xl lg:hidden">
